...
public class ScanTest extends SimpleDbTestBase {
    ...
    /** Scan 1-4 columns. */
    @Test public void testSmall() throws IOException, DbException, TransactionAbortedException, NoSuchFieldException {
    ...
    @Test public void testRewind() throws IOException, DbException, TransactionAbortedException, NoSuchFieldException {
        ArrayList<ArrayList<Integer>> tuples = new ArrayList<ArrayList<Integer>>();
     ...
     * @throws DbException */
    @Test public void testCache() throws IOException, DbException, TransactionAbortedException, NoSuchFieldException {
